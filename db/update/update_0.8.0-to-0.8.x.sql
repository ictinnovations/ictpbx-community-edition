...
ALTER TABLE usr ADD daily_limit      int(16)       NOT NULL default 0 AFTER active;
ALTER TABLE usr ADD monthly_limit    int(16)       NOT NULL default 0 AFTER daily_limit;
ALTER TABLE usr ADD daily_sent       int(16)       NOT NULL default 0 AFTER monthly_limit;
ALTER TABLE usr ADD monthly_sent     int(16)       NOT NULL default 0 AFTER daily_sent;

-- ALTER TABLE CAMPAIGN

ALTER TABLE campaign ADD reason      varchar(128)  NOT NULL default '' AFTER status;
