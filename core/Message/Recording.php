...
class Recording extends Message
{
  ...
  public static function search($aFilter = array())
  {
    ...
    $query = "SELECT recording_id, tenant_id, name, file_name, type, length, description FROM " . $from_str;
  ...
  public function save()
  {
    $data = array(
        ...
        'name' => $this->name,
        'file_name' => empty($this->file_name) ? 'pending.wav' : $this->file_name,
        'type' => empty($this->type) ? 'wav' : $this->type,
