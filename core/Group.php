...
class Group
{
  ...
  public static function search($aFilter = array())
  {
    ...
    $query = "SELECT group_id, tenant_id, name, contact_total FROM " . $from_str;
  ...
  public function query()
  {
   ...
   $is_tenant = (can_access('user_admin', $user_id)) ? "1" : "0";
    ...
    $query = "SELECT * FROM " . self::$table . " WHERE group_id='%group_id%' AND tenant_id=$tenant_id";
   }

   else{
   $query = "SELECT * FROM " . self::$table . " WHERE group_id='%group_id%' AND created_by=$user_id";
   }
      return $query;
  }
