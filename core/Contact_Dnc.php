...
class Contact_Dnc
{
  ...
  public static function search($aFilter = array(), $full = false)
  {
    ...
    if ($full) {
      $query = "SELECT contact_dnc_id, tenant_id, first_name, last_name, phone, email, address, "
              ."custom1, custom2, custom3, description FROM " . $from_str;
            } else {
              $query = "SELECT contact_dnc_id, tenant_id, first_name, last_name, phone, email FROM " . $from_str;
            }
    ...
    if (empty($aContact_Dnc) && isset($aFilter['contact_dnc_id']) && $aFilter['contact_dnc_id'] == Contact_Dnc::COMPANY) {
      ...
      $singleContact_Dnc['tenant_id'] = $oContact_Dnc->tenant_id;
  ...
  public function delete()
  {
    ...
    //mysqli_query(DB::$link , "DELETE from contact_link where contact_dnc_id=".$this->contact_dnc_id);
    return DB::delete('contact_dnc', 'contact_dnc_id', $this->contact_dnc_id);
  }
