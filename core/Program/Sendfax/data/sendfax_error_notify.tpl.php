...
$template['attachment'] = "[document:file_name]";
$template['body'] = <<<EOS
...
We have tried to send your fax to [fax:transmission:contact:phone] but unfortunately it failed.<br><br>

Error: [fax:transmission:spool:response]<br><br>
Try Done: [fax:transmission:try_done]<br><br>
<b>User Account</b><br>
Name: [fax:transmission:account:first_name] [fax:transmission:account:last_name]<br>
Username: [fax:transmission:account:username]<br>
Email: [fax:transmission:account:email]<br>
Contact: [fax:transmission:contact:phone]<br><br>
