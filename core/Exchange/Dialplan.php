...
class Dialplan
{
  ...
  public function save()
  {
    ...
    $check_index = "SELECT * FROM dialplan where gateway_flag = '$this->gateway_flag' AND source = '$this->source' AND destination = '$this->destination'";
    $result = DB::query(self::$table, $check_index);
