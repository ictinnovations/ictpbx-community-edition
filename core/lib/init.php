...
global $path_lib, $path_core, $path_root, $path_www, $path_etc, $path_log, $path_data, $path_cache, $path_template, $website_log, $freeswitch_log;
...
$freeswitch_log = Conf::get('freeswitch:fs_cli');
